...
document.addEventListener('DOMContentLoaded', function () {
    ...
    let events = [
        { id: "1", title: "World Braille Day", start: "2024-10-01", className: "bg-success", allDay: true, extendedProps: { label: "Holiday", description: "Celebrating the importance of Braille." } },
        { id: "2", title: "World Leprosy Day", start: "2024-10-22", className: "bg-primary", allDay: true, extendedProps: { label: "Meeting", description: "Raising awareness about leprosy." } },
        { id: "3", title: "All Day Event", start: new Date(y, m, 1), className: "bg-primary", allDay: true, extendedProps: { label: "Meeting", description: "General all-day event." } },
        { id: "4", title: "Birthday Party", start: new Date(y, m, d + 1), className: "bg-danger", allDay: true, extendedProps: { label: "Birthday", description: "Celebrating a friend's birthday." } },
        { id: "5", title: "Repeating Event", start: new Date(y, m, d + 4), end: new Date(y, m, d + 9), className: "bg-warning", allDay: true, extendedProps: { label: "Deadline", description: "A repeating event over multiple days." } },
        { id: "6", title: "Weekend Trip", start: new Date(y, m, d + 15), className: "bg-success", allDay: true, extendedProps: { label: "Holiday", description: "Weekend trip to relax and enjoy nature." } },
        { id: "7", title: "Medical Leave", start: new Date(y, m, d - 2), className: "bg-info", allDay: true, extendedProps: { label: "Sick Leave", description: "Medical leave due to illness." } },
        { id: "8", title: "Company Annual Meeting", start: new Date(y, m, d + 10), className: "bg-primary", allDay: true, extendedProps: { label: "Meeting", description: "Annual company-wide meeting." } },
        { id: "9", title: "Project Deadline", start: new Date(y, m, d + 18), className: "bg-warning", allDay: true, extendedProps: { label: "Deadline", description: "Final submission deadline for project." } },
        { id: "15", title: "National Holiday", start: new Date(y, m, d + 20), className: "bg-success", allDay: true, extendedProps: { label: "Holiday", description: "Public national holiday." } },
        { id: "16", title: "Training Session", start: new Date(y, m, d + 11), className: "bg-primary", allDay: true, extendedProps: { label: "Meeting", description: "Employee training and skill development." } },
        { id: "17", title: "Financial Report Submission", start: new Date(y, m, d + 9), className: "bg-warning", allDay: true, extendedProps: { label: "Deadline", description: "Deadline for financial report submission." } },
        { id: "18", title: "Kids' Sports Day", start: new Date(y, m, d + 6), className: "bg-danger", allDay: true, extendedProps: { label: "Birthday", description: "A fun sports event for kids." } },
        { id: "19", title: "Camping Trip", start: new Date(y, m, d + 14), className: "bg-success", allDay: true, extendedProps: { label: "Holiday", description: "Outdoor camping with friends and family." } },
        { id: "20", title: "Health Checkup", start: new Date(y, m, d - 1), className: "bg-info", allDay: true, extendedProps: { label: "Sick Leave", description: "Routine health checkup." } },
    ];
