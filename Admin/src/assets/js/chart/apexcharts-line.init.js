...
var lineLabelChart = null;
var steplineChart = null;
var apexlineChart = null;
var datetimexaxisareaChart = null;
var columnWithLabel = null;
var basicbarChart = null;
var negativebarchart = null;
var linecolumnChart = null;
var funnelChart = null;
var basicpieChart = null;
var donutChart = null;
var radarCharts = null;
var radarmultiplechart = null;
var radialbarChart = null;
var multipleradialbarsChart = null;
...
function renderCharts() {
  ...
  lineLabelChart ? lineLabelChart.destroy() : null;
  lineLabelChart = new ApexCharts(
    document.querySelector("#line_with_data_label"),
    line_with_data_label
  );
  lineLabelChart.render();
  ...
  steplineChart ? steplineChart.destroy() : null;
  steplineChart = new ApexCharts(
    document.querySelector("#step_line_line_chart"),
    step_line_line_chart
  );
  ...
  apexlineChart ? apexlineChart.destroy() : null;
  apexlineChart = new ApexCharts(
  ...
  datetimexaxisareaChart ? datetimexaxisareaChart.destroy() : null;
  datetimexaxisareaChart = new ApexCharts(
    document.querySelector("#datetime_xaxis_area_chart"),
    datetime_xaxis_area_chart
  );
  datetimexaxisareaChart.render();
  ...
  var basic_column_chart = {
    ...
    colors: getColors(["--pe-primary", "--pe-success", "--pe-warning"]),
    plotOptions: {
      bar: {
        horizontal: false,
        columnWidth: "55%",
  ...
  var negative_bar_chart = {
    ...
    colors: getColors(["--pe-primary", "--pe-danger"]),
    plotOptions: {
      bar: {
        borderRadius: 5,
  ...
  negativebarchart ? negativebarchart.destroy() : null;
  negativebarchart = new ApexCharts(
  ...
  linecolumnChart ? linecolumnChart.destroy() : null;
  linecolumnChart = new ApexCharts(
  ...
  funnelChart ? funnelChart.destroy() : null;
  ...
  var chart = new ApexCharts(
    document.querySelector("#Box_Whisker_chart"),
    Box_Whisker_chart
  );
  chart.render();
  ...
  var basic_pie_chart = {
    ...
    colors: getColors(["--pe-danger", "--pe-success", "--pe-primary"]),
    legend: {
      position: "bottom", // Positioning the legend at the bottom
    },
  };
  basicpieChart ? basicpieChart.destroy() : null;
  basicpieChart = new ApexCharts(
  ...
  donutChart ? donutChart.destroy() : null;
  ...
  radarCharts ? radarCharts.destroy() : null;
  radarCharts = new ApexCharts(
    document.querySelector("#radar_charts"),
    radar_charts
  );
  radarCharts.render();
  ...
  var radar_multiple_chart = {
    ...
    colors: getColors(["--pe-warning", "--pe-success", "--pe-primary"]),
    markers: {
      size: 0,
    },
    yaxis: {
  ...
  radialbarChart ? radialbarChart.destroy() : null;
  radialbarChart = new ApexCharts(
    document.querySelector("#radialbar_chart"),
    radialbar_chart
  );
  ...
  var multiple_radialbars_chart = {
    ...
    colors: getColors(["--pe-primary", "--pe-danger", "--pe-warning", "--pe-success"]),
    labels: ["Apples", "Oranges", "Bananas", "Berries"],
  };
  multipleradialbarsChart ? multipleradialbarsChart.destroy() : null;
  multipleradialbarsChart = new ApexCharts(
    document.querySelector("#multiple_radialbars_chart"),
    multiple_radialbars_chart
  );
  multipleradialbarsChart.render();
}
